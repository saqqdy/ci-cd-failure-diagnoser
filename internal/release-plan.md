...
### v0.1.0 — 项目骨架 + 本地日志诊断 MVP

> 对应 Phase 0 + Phase 1，2 天

| 项目 | 内容 |
|------|------|
| **范围** | 项目初始化 + 本地日志文件 → AI 诊断 → 结构化输出 |
| **包含** | 项目骨架、核心数据模型、本地文件适配器、日志预处理、两阶段 AI 分类+诊断 |
...
- [x] `/diagnose` 命令可触发 ✅
- [x] 项目结构符合规划 ✅
- [x] 核心模块单元测试通过 ✅ (8 tests passed)
- [x] 5 种测试日志样本 ✅
- [x] AI 输出可被程序解析为 DiagnosisResult ✅
- [x] 错误处理完备 ✅
- [x] README 包含基本使用说明 ✅
- [x] `npm pack` 可正常打包 ✅ (11.6KB tarball)
...
2026-06
───────
W1: v0.1.0 (项目骨架 + 本地日志诊断)
W2: v0.2.0 (GitHub Actions 集成)
W3: v0.3.0 (修复建议生成)
W4: v0.4.0 (模式引擎)
